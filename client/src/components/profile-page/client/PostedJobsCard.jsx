...
import { Users, Edit3, Trash2, DollarSign, Briefcase } from "lucide-react";
import { projectCardVariants, buttonVariants } from "../../ui/animations";
      ...
      >
        ...
        <div className="flex-1 flex flex-col space-y-2 sm:space-y-3">
          ...
          >
            ...
            <span className="line-clamp-2 break-words">{postedJob.title}</span>
          </motion.h3>
          ...
          >
            ...
            <span className="font-medium text-green-700 dark:text-green-300">
              Budget: ${Number(postedJob.budget).toLocaleString()}
            </span>
          </motion.div>
        </div>
        ...
        >
          ...
          <motion.button
            onClick={() => onViewApplicants(postedJob)}
            ...
            whileTap="tap"
          >
            <Users className="size-3 sm:size-4 lg:size-5 flex-shrink-0" />
            <span className="truncate">View Applicants</span>
          </motion.button>

          <motion.button
            onClick={() => onEditJob(postedJob)}
            ...
            whileTap="tap"
          >
            <Edit3 className="size-3 sm:size-4 lg:size-5 flex-shrink-0" />
            <span className="truncate">Edit Job</span>
          </motion.button>

          <motion.button
            onClick={() => onDeleteJob(postedJob)}
